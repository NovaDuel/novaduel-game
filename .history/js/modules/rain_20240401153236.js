export function rain() {
    ...
    while (increment < 100) {
        ...
        drops += '<div class="drop" style="left: ' + increment + '%; bottom: ' + (randoFive + randoFive - 1 + 100) + '%; animation-delay: 0.' + randoHundred + 's; animation-duration: 0.5' + randoHundred + 's;"><div class="stem" style="animation-delay: 0.' + randoHundred + 's; animation-duration: 0.5' + randoHundred + 's;"></div><div class="splat" style="animation-delay: 0.' + randoHundred + 's; animation-duration: 0.5' + randoHundred + 's;"></div></div>';
